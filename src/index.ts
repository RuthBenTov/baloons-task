...
//----------------------------------------------variables------------------------------------------------------------------------
let balloon = document.querySelector("#balloon")as HTMLImageElement
let goldenBalloon = document.querySelector("#goldenBalloon") as HTMLImageElement
var yPos = 101;
...
let ctrScore = 0
let life = 3
let lifeLevel =document.querySelector(".lifeLevel") as HTMLParagraphElement
let audioBack = document.querySelector(".audioBack") as HTMLAudioElement
let popSound = document.querySelector(".popSound") as HTMLAudioElement
let errorSound = document.querySelector(".errorSound") as HTMLAudioElement
let hundredSound = document.querySelector(".hundredSound") as HTMLAudioElement
